...
def emailConfirmacaoEvento(emailPet: str, senhaPet: str, emailDestino: str, nomeEvento: str, localEvento: str, dataEvento: str, coindicoesEvento: str) -> None:
    m: EmailMessage = EmailMessage()
    m['From'] = emailPet
    m['To'] = emailDestino
    m['Subject'] = "PET-Info: Você foi cadastrado no evento" + nomeEvento
    m.set_content("Nome do evento: " + nomeEvento + "\nLocal do Evento: " + localEvento + "\nData do evento: " + dataEvento + "Nesse evento você optou por: " + coindicoesEvento)
